...
class AdaSPLoss(object):
    """
    Robust Adaptive Sparse Pairwise (AdaSP) Loss
    Rewritten to support random dataloaders and dynamic batch sizes.
    """
    ...
    def __call__(self, feats, targets):
        ...
        # Y: (N, N_id) - maps each instance to its class
        ...
        # mask_HH and mask_HE: -1 for positive pairs, 1 for negative pairs
